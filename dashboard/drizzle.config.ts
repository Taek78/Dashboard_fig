 ...
 * Next (pas d'alias @/, .env.local non chargé par Next) : on le lit nous-mêmes
 * avec l'API de Node, puis process.env, avec un message clair plutôt qu'un `!`
 * qui masquerait une variable absente.
 */
