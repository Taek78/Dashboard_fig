...
export function CheckChip({
  ...
  return (
    <label
      htmlFor={id}
      className={cn(
        "bg-card border-input hover:bg-muted/40 has-focus-visible:ring-ring/50 inline-flex h-9 cursor-pointer items-center gap-2 rounded-none border px-3 text-sm font-medium transition-colors select-none has-focus-visible:ring-3 motion-safe:transition-[color,background-color,box-shadow,scale] motion-safe:active:scale-95",
        accent === "destructive"
