...
const SidebarMobileSheet = dynamic(
  () =>
    import("@/components/ui/sidebar-mobile").then((m) => m.SidebarMobileSheet),
  { ssr: false },
);
    ...
    >
      ...
      >
        <div
          ...
          className="bg-sidebar group-data-[variant=floating]:ring-sidebar-border flex size-full flex-col rounded-none group-data-[variant=floating]:shadow-sm group-data-[variant=floating]:ring-1"
        >
          {children}
        </div>
      </div>
