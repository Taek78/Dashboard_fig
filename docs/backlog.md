...
**Mise à jour du 2026-09-08.** Zaki avance sur les fonctionnalités et n'écrit pas de tests ; Claude écrit et maintient les tests dans `dashboard/test/` (miroir de `src/`) à chaque étape. A1.1 et A1.2 sont livrés (statuts en clés anglaises `pending … cancelled`, 14 fixtures, règle pure) et testés. Prochaine étape : A1.3.
