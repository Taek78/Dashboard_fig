...
| `communities`        | groupes de clients livrés à un point de retrait, avec leur remise                                                                                                                                      | créées par l'application FIG, lues par le dashboard                                                                                                                                                                      |
